...
function init() {
  ...
  var onLoad = function onLoad(event) {
    var obj = event.detail.loaderRootNode; //obj.scale.set(0.25, 0.25, 0.25);
    ...
    console.log(obj.position.x); //obj.rotation.y = -Math.PI / 2;
  ...
  light.position.set(0, 0, 30); //light.castShadow = true;
