...
var main = function main(p5) {
  p5.setup =
  /*#__PURE__*/
  _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee() {
    var hero, imgPath, i, x, y, xspeed, yspeed, masateru;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            hero = document.getElementsByClassName("hero")[0];
            canvas = p5.createCanvas(hero.clientWidth, hero.clientHeight);
            canvas.parent(hero);
            canvas.position(0, 0);
