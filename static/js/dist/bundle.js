...
function init() {
  ...
  ObjLoader.load("models/mask.obj", function (obj) {
    ...
    scene.add(obj);
  }, onProgress, onError); //light

  var light = new THREE.DirectionalLight("white", 1);
  light.position.set(0, 0, 30);
  light.castShadow = true;
  scene.add(light); //const ambient = new THREE.AmbientLight(0xffffff);
  //scene.add(ambient);
  ...
  renderer.shadowMap.enabled = true; //const geometry = new THREE.BoxGeometry(400, 400, 400);
