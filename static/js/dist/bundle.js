...
function hideLoadingScreen() {//$('#loading-screen').hide('slide', { 
  //direction: 'right',
...
function init() {
  ...
  var model; //const MtlLoader = new THREE.MTLLoader();
              ...
              case 0:
                if (node.material) {
                  loadTexture = function loadTexture() {
                    ...
                    return new Promise(function (resolve, reject) {
                      try {
                        var url = "https://threejsfundamentals.org/threejs/resources/images/flower-1.jpg";
  ...
  var filename = 'models/masateru2.obj'; //const filename = 'models/mask.obj';

  ObjLoader.load(filename, onLoad, onProgress, onError, null, true);
  var light = new THREE.DirectionalLight("white", 1);
  light.position.set(0, 0, 10); //light.castShadow = true;
  ...
  camera.lookAt(scene.position); //const axis = new THREE.AxesHelper(2000);
...
var _face3d = require("./face3d.js"); //new p5(masateru);
