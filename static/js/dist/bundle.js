    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            canvasEl = document.getElementById(canvas.id());
            context = canvasEl.getContext('webgl', {
              alpha: true
            }); //context.clearDepth(0.1);

            context.colorMask(true, true, true, true);
            context.clearColor(0, 0, 0, 0); //p5.clear();

            context.clear(context.DEPTH_BUFFER_BIT | context.COLOR_BUFFER_BIT); //context.drawElements(context.TRIANGLES, 100, context.UNSIGNED_SHORT, 0);
            //p5.push();
...
function craeateCanvasOfParentSize(p5, parent) {
  canvas = p5.createCanvas(parent.clientWidth, parent.clientHeight, p5.WEBGL); //canvas = p5.createCanvas(parent.clientWidth, parent.clientHeight);
  //canvas = p5.select('#canvas3d');
  //canvas.parent(parent);

  canvas.position(0, 0);
  canvas.style('z-index', '3000');
  var gl = start(canvas); //canvas.style('opacity', '0.5');
...
function start(glCanvas) {
  var can = document.getElementById(glCanvas.id());
  var gl = initWebGL(can);

  if (gl) {
    gl.clearColor(0.0, 0.0, 0.0, 0); // 深度テストを有効化
...
var _masateru = require("./masateru.js");

var _face3d = require("./face3d.js");

new p5(_masateru.masateru);
new p5(_face3d.face3d);

},{"./face3d.js":332,"./masateru.js":334,"babel-polyfill":1}],334:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.masateru = void 0;
...
var sketch = function sketch(p5) {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee() {
    var hero, imgPath, i, x, y, xspeed, yspeed, _masateru;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            for (i = 0; i < 5; i++) {
              ...
              _masateru = new Person(p5, imgPath, x, y, xspeed, yspeed);
              masaterus.push(_masateru);
            }
